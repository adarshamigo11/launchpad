      ...
      <section className="py-16 sm:py-20 md:py-24 bg-white">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-3xl font-bold text-[#007BFF] mb-6">What Makes Our Community Unique</h2>
            
            <div className="space-y-6 mb-8">
              <div>
                <h3 className="text-xl font-semibold text-[#007BFF] mb-2">Collaborative Learning:</h3>
                <p className="text-lg text-gray-700">Engage with driven individuals who push you to think bigger and perform better.</p>
              </div>
              
              <div>
                <h3 className="text-xl font-semibold text-[#007BFF] mb-2">Peer Interaction:</h3>
              ...
              <div>
                <h3 className="text-xl font-semibold text-[#007BFF] mb-2">Networking & Growth:</h3>
              ...
              <div>
                <h3 className="text-xl font-semibold text-[#007BFF] mb-2">Culture of Encouragement:</h3>
