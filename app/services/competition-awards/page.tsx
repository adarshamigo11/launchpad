      ...
      <section className="py-16 sm:py-20 md:py-24 bg-white">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-3xl font-bold text-[#144449] mb-6">The Competitive Edge</h2>
            ...
            <h2 className="text-3xl font-bold text-[#144449] mb-6">The Final Showdown</h2>
            ...
            <h3 className="text-2xl font-bold text-[#144449] mb-4">Why It Matters</h3>
            
            <div className="space-y-6 mb-8">
              <div>
                <h4 className="text-xl font-semibold text-[#144449] mb-2">Gain Recognition:</h4>
              ...
              <div>
                <h4 className="text-xl font-semibold text-[#144449] mb-2">Meet the Masters:</h4>
              ...
              <div>
                <h4 className="text-xl font-semibold text-[#144449] mb-2">Build Confidence:</h4>
              ...
              <div>
                <h4 className="text-xl font-semibold text-[#144449] mb-2">Career Growth:</h4>
