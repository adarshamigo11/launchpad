  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="relative z-20 w-full h-full flex items-center justify-center">
          <div className="text-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-4 sm:mb-6">
              <span className="text-[#144449]">LAUNCH</span><span className="text-[#BF9B30]">PAD</span>
            </h1>
            ...
            {!currentUser && (
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4">
                <Link href="/login" className="w-full sm:w-auto">
                  <Button size="lg" className="w-full sm:w-auto bg-[#BF9B30] text-black hover:bg-[#BF9B30]/90 font-bold text-base sm:text-lg px-6 sm:px-8 py-3">
                    Start Your Journey
                  </Button>
                </Link>
                <Link href="/about" className="w-full sm:w-auto">
                  <Button size="lg" variant="outline" className="w-full sm:w-auto border-white text-white hover:bg-white hover:text-[#144449] font-semibold text-base sm:text-lg px-6 sm:px-8 py-3 !bg-transparent !border-white !text-white hover:!bg-white hover:!text-[#144449]">
                    Learn More
                  </Button>
                </Link>
              </div>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center">
            <div className="order-2 lg:order-1 animate-slide-in-left">
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-[#144449] mb-4 sm:mb-6 text-center lg:text-left">What is Launchpad?</h2>
      ...
      <section className="py-16 sm:py-20 md:py-24 bg-gray-50">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-center text-[#144449] mb-8 sm:mb-12">What We Offer</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 ease-in-out cursor-pointer group">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#BF9B30] rounded-lg flex items-center justify-center mb-3 sm:mb-4 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300">
                <span className="text-black text-lg sm:text-xl group-hover:scale-110 transition-transform duration-300">👥</span>
              </div>
              <h3 className="text-lg sm:text-xl font-semibold text-[#144449] mb-2 sm:mb-3 group-hover:text-[#144449]/90 transition-colors duration-300">Expert Mentorship</h3>
              ...
              <Link href="/services/expert-mentorship">
                <Button className="w-full bg-[#144449] text-white hover:bg-[#144449]/90 text-sm font-medium group-hover:shadow-lg transition-all duration-300">
                  Learn More
                </Button>
              </Link>
            </div>
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 ease-in-out cursor-pointer group">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-[#144449] mb-2 sm:mb-3 group-hover:text-[#144449]/90 transition-colors duration-300">Ready-to-Sell Services</h3>
              <p className="text-sm sm:text-base text-gray-600 mb-4 group-hover:text-gray-700 transition-colors duration-300">
            ...
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 ease-in-out cursor-pointer group">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#144449] rounded-lg flex items-center justify-center mb-3 sm:mb-4 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300">
                <span className="text-white text-lg sm:text-xl group-hover:scale-110 transition-transform duration-300">🏆</span>
              </div>
              <h3 className="text-lg sm:text-xl font-semibold text-[#144449] mb-2 sm:mb-3 group-hover:text-[#144449]/90 transition-colors duration-300">Competition & Awards</h3>
              <p className="text-sm sm:text-base text-gray-600 mb-4 group-hover:text-gray-700 transition-colors duration-300">
            ...
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 ease-in-out cursor-pointer group">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-[#144449] mb-2 sm:mb-3 group-hover:text-[#144449]/90 transition-colors duration-300">Real-World Experience</h3>
              <p className="text-sm sm:text-base text-gray-600 mb-4 group-hover:text-gray-700 transition-colors duration-300">
            ...
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 ease-in-out cursor-pointer group">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-[#144449] mb-2 sm:mb-3 group-hover:text-[#144449]/90 transition-colors duration-300">Supportive Community</h3>
              <p className="text-sm sm:text-base text-gray-600 mb-4 group-hover:text-gray-700 transition-colors duration-300">
            ...
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 ease-in-out cursor-pointer group">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-[#144449] mb-2 sm:mb-3 group-hover:text-[#144449]/90 transition-colors duration-300">Structured Learning</h3>
              <p className="text-sm sm:text-base text-gray-600 mb-4 group-hover:text-gray-700 transition-colors duration-300">
      ...
      <section className="py-16 bg-white">
        <div className="mx-auto max-w-6xl px-4">
          <h2 className="text-6xl font-bold text-center text-[#144449] mb-12">3-Month Challenge</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h3 className="text-2xl font-semibold text-[#144449] mb-4">Competition Duration</h3>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 bg-[#BF9B30] rounded-full flex items-center justify-center">
            ...
            <div 
              ref={rightRef}
              className={`bg-gradient-to-br from-[#144449] to-[#BF9B30] p-8 rounded-lg text-white transition-all duration-1000 ease-out ${
                isRightVisible 
                  ? 'opacity-100 translate-x-0' 
                  : 'opacity-0 translate-x-12'
              }`}
            >
              ...
              {!currentUser && (
                <Link href="/login">
                  <Button className="bg-white text-[#144449] hover:bg-gray-100 font-semibold !bg-white !text-[#144449] hover:!bg-gray-100">
                    Register Now
                  </Button>
                </Link>
              )}
      ...
      <section className="py-16 sm:py-20 md:py-24 bg-gradient-to-br from-gray-50 via-white to-gray-100 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-20 -right-20 w-40 h-40 bg-[#BF9B30]/5 rounded-full blur-2xl"></div>
          <div className="absolute -bottom-20 -left-20 w-40 h-40 bg-[#144449]/5 rounded-full blur-2xl"></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-60 h-60 bg-gradient-to-r from-[#BF9B30]/3 to-[#144449]/3 rounded-full blur-3xl"></div>
        </div>
        
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-8 sm:mb-12">
            <div className="inline-block mb-4 sm:mb-6">
              <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-r from-[#BF9B30] to-[#144449] rounded-full flex items-center justify-center mx-auto animate-pulse">
                <span className="text-white text-2xl sm:text-3xl">🏆</span>
              </div>
            </div>
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-center bg-gradient-to-r from-[#144449] to-[#BF9B30] bg-clip-text text-transparent mb-4 sm:mb-6">Launchpad Award Night</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="bg-white p-6 sm:p-8 rounded-lg shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 ease-in-out cursor-pointer group relative overflow-hidden">
              ...
              <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-[#BF9B30] to-[#FFA000] rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 shadow-lg group-hover:shadow-xl">
                <span className="text-black text-2xl sm:text-3xl font-bold group-hover:scale-110 transition-transform duration-300">💰</span>
              </div>
              <h3 className="text-xl sm:text-2xl font-semibold text-[#144449] mb-3 sm:mb-4 group-hover:text-[#144449]/90 transition-colors duration-300 text-center">Highest Turnover</h3>
              ...
              {/* Award badge effect */}
              <div className="absolute -top-2 -right-2 w-6 h-6 bg-gradient-to-r from-[#BF9B30] to-[#FFA000] rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
            ...
            <div className="bg-white p-6 sm:p-8 rounded-lg shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 ease-in-out cursor-pointer group relative overflow-hidden">
              ...
              <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-[#144449] to-[#0056CC] rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 shadow-lg group-hover:shadow-xl">
                <span className="text-white text-2xl sm:text-3xl font-bold group-hover:scale-110 transition-transform duration-300">🎨</span>
              </div>
              <h3 className="text-xl sm:text-2xl font-semibold text-[#144449] mb-3 sm:mb-4 group-hover:text-[#144449]/90 transition-colors duration-300 text-center">Best Branding</h3>
              <p className="text-gray-600 text-sm sm:text-base group-hover:text-gray-700 transition-colors duration-300 text-center">
                Most creative brand identity
              </p>
              
              {/* Award badge effect */}
              <div className="absolute -top-2 -right-2 w-6 h-6 bg-gradient-to-r from-[#144449] to-[#0056CC] rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                <span className="text-white text-xs">★</span>
              </div>
            </div>
            <div className="bg-white p-6 sm:p-8 rounded-lg shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 ease-in-out cursor-pointer group relative overflow-hidden">
              ...
              <h3 className="text-xl sm:text-2xl font-semibold text-[#144449] mb-3 sm:mb-4 group-hover:text-[#144449]/90 transition-colors duration-300 text-center">Rising Star</h3>
              <p className="text-gray-600 text-sm sm:text-base group-hover:text-gray-700 transition-colors duration-300 text-center">
