    ...
    <div className="min-h-screen">
      ...
      <section className="relative pt-0 pb-32 md:pb-40 overflow-hidden min-h-screen flex items-center">
        ...
        <div className="relative z-20 w-full h-full flex items-center justify-center">
          <div className="text-center max-w-4xl mx-auto px-4 mt-15">
      ...
      <section className="py-16 bg-gray-50">
        <div className="mx-auto max-w-6xl px-4">
          <h2 className="text-6xl font-bold text-center text-[#007BFF] mb-12">Why Choose Launchpad?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-white rounded-lg shadow-lg">
              ...
              <h3 className="text-xl font-semibold text-[#007BFF] mb-3">Mentorship</h3>
            ...
            <div className="text-center p-6 bg-white rounded-lg shadow-lg">
              ...
              <h3 className="text-xl font-semibold text-[#007BFF] mb-3">Competition & Recognition</h3>
              <p className="text-gray-600">
